...
import {
    ...
    ApiFail422FromJSON,
    ApiFail422ToJSON,
    AppointmentCancelPutPayloadFromJSON,
    AppointmentCancelPutPayloadToJSON,
    AppointmentCollectionFromJSON,
    AppointmentCollectionToJSON,
    AppointmentReschedulePutPayloadFromJSON,
    AppointmentReschedulePutPayloadToJSON,
    AppointmentResourceFromJSON,
    AppointmentResourceToJSON,
    AppointmentUpdatePutPayloadFromJSON,
