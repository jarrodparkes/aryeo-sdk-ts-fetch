...
exports.instanceOfAddressPostPayload = instanceOfAddressPostPayload;
exports.AddressPostPayloadFromJSON = AddressPostPayloadFromJSON;
exports.AddressPostPayloadFromJSONTyped = AddressPostPayloadFromJSONTyped;
exports.AddressPostPayloadToJSON = AddressPostPayloadToJSON;
exports.AddressPostPayloadToJSONTyped = AddressPostPayloadToJSONTyped;
/**
 * Check if a given object implements the AddressPostPayload interface.
 */
function instanceOfAddressPostPayload(value) {
...
function AddressPostPayloadFromJSON(json) {
    return AddressPostPayloadFromJSONTyped(json, false);
}
function AddressPostPayloadFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function AddressPostPayloadToJSON(json) {
    return AddressPostPayloadToJSONTyped(json, false);
}
function AddressPostPayloadToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
